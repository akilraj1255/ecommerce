...
urlpatterns = patterns('',
    ...
    #can't with the same regex matching. 
    url(r'^products/category/(?P<category>[-A-Za-z]+)/$', 'products.views.display_category', name='display_category'),
    ...
    url(r'^checkout/$', 'carts.views.checkout', name='checkout'),
