...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductImage.productSet'
        db.add_column(u'products_productimage', 'productSet',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductImage.productSet'
        db.delete_column(u'products_productimage', 'productSet')
    ...
    models = {
        ...
        u'products.productimage': {
            ...
            'productSet': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
