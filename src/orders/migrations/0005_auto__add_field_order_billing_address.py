...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field addresses on 'Order'
        db.delete_table(db.shorten_name(u'orders_order_addresses'))
    ...
    def backwards(self, orm):
        ...
        # Adding M2M table for field addresses on 'Order'
        m2m_table_name = db.shorten_name(u'orders_order_addresses')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('order', models.ForeignKey(orm[u'orders.order'], null=False)),
            ('address', models.ForeignKey(orm[u'profiles.address'], null=False))
        ))
        db.create_unique(m2m_table_name, ['order_id', 'address_id'])
    ...
    models = {
        ...
        u'orders.order': {
            ...
            'billing_address': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['profiles.Address']", 'null': 'True', 'blank': 'True'}),
        ...
        u'profiles.address': {
            ...
            'fullname': ('django.db.models.fields.CharField', [], {'max_length': '120', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
